                ...
                {PLATFORMS.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 p-3 rounded-md border transition-all duration-150 ${active ? "bg-red-50 border-red-300 text-red-500 scale-103" : "bordder-slate-200 text-slate-500 hover:border-slate-300"}`}
                    >
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex gap-1.5 items-center">
                      {post.platforms.map((pl: string) => {
                        ...
                        return meta ? (
                          <meta.icon key={pl} className="3.5 text-slate-400" />
                        ) : null;
                      })}
                    </div>
